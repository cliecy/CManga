...
class DirectoryPicker {
  ...
  static const _methodChannel = MethodChannel("cmanga/method_channel");
...
class IOSDirectoryPicker {
  static const MethodChannel _channel = MethodChannel("cmanga/method_channel");
...
Future<FileSelectResult?> selectFile({required List<String> ext}) async {
  ...
  try {
    ...
    if (App.isAndroid) {
      const selectFileChannel = MethodChannel("cmanga/select_file");
      String mimeType = "*/*";
      if (ext.length == 1) {
