...
int _nextComicHeroID = 0;

/// Identifies one cover occurrence, not a comic shared across multiple sections.
int allocateComicHeroID() => _nextComicHeroID++;
...
class _SliverGridComicsState extends State<SliverGridComics> {
  ...
  void generateHeroID() {
    ...
    for (var i = 0; i < comics.length; i++) {
      heroIDs.add(allocateComicHeroID());
    }
  }
