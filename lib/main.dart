...
import 'package:cmanga/pages/auth_page.dart';
import 'package:cmanga/pages/main_page.dart';
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  ThemeData getTheme(
    ...
    if (appdata.settings['color'] == 'teal' && brightness == Brightness.light) {
      scheme = scheme.copyWith(
        primary: const Color(0xFF167D8D),
        onPrimary: Colors.white,
        surface: const Color(0xFFF6F3EB),
        onSurface: const Color(0xFF142B36),
        surfaceContainerLowest: const Color(0xFFFFFDF8),
        surfaceContainerLow: const Color(0xFFF1EFE7),
        surfaceContainer: const Color(0xFFECECE3),
        surfaceContainerHigh: const Color(0xFFE5E9E1),
        surfaceContainerHighest: const Color(0xFFDDE3DC),
      );
    }
    return ThemeData(
      colorScheme: scheme,
